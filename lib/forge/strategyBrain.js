...
- If the resume does not prove it, use this exact pattern:
  "This resume does not currently demonstrate [missing signal], which is a required signal for this role and may prevent it from advancing."
- Then give conditional next steps:
  "If true, add [specific evidence] in [specific section]."
  "If not true, do not claim it. Strengthen [closest honest adjacent evidence] instead."
