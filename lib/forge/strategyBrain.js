...
Do not add years of experience, tool names, certifications, degrees, or platforms unless they are explicitly present in the resume snapshot.
If the JD asks for something missing, name it as a gap. Do not pretend the candidate has it.
`.trim();
}
