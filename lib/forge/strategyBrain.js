...
${isOverview ? `JSON SHAPE FOR OVERVIEW:
{
  ...
  "environment": "${hammerContext.environment.label}",
"matchAssessment": "Write your private recruiter read here. Lead with the biggest blocker. Name the strongest visible support. Use specific evidence from the JD and resume. Do NOT repeat these instructions in the output. Do NOT use template phrasing.",  "signalGaps": [
