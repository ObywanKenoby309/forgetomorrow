...
1. Identify the required signal from the JD
2. State whether the resume proves it
3. Provide:
   - "If true" action (specific placement)
   - "If not true" fallback (adjacent evidence)

If both paths are not present, the output is incomplete.
