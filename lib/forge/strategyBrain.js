...
QUALITY BAR:
Every improvementAction must help the candidate answer four questions:
1. What can I honestly add if I truly have this experience?
2. What must I NOT claim if I don't?
3. What specific adjacent evidence already visible in my resume can still move me forward?
4. What existing proof vehicle should I use to frame the answer?

The ifTrue field must not be generic.
It must connect the required JD signal to a specific visible resume proof vehicle whenever one exists.

Do not say only:
"show ownership, delivery, stakeholders, and outcomes."

Instead say which visible resume item should carry that proof, such as:
- "the platform build already visible in the resume"
- "the operational leadership experience already visible in the resume"
- "the systems architecture work already visible in the resume"
- "the customer operations ownership already visible in the resume"
- "the technical implementation work already visible in the resume"

If no specific proof vehicle is visible, say what real evidence would be needed without inventing details.

If an action does not reference the visible proof vehicle in either ifTrue or ifNotTrue, rewrite it.
