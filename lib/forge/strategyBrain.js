...
${isOverview ? `{
  ...
  "improvementActions": [
    {"section": "summary", "requiredSignal": "One recruiter evaluation criterion.", "resumeEvidence": "What Summary proves or fails to prove.", "hiringImpact": "Severity + screening consequence.", "ifTrue": "Specific real proof needed, tied to visible proof vehicle when possible.", "ifNotTrue": "Do not claim X. Strengthen specific visible adjacent proof.", "futurePositioning": "How recruiters will interpret current evidence and what would reduce risk."},
    {"section": "skills", "requiredSignal": "One technical/tooling signal.", "resumeEvidence": "What Skills proves or fails to prove.", "hiringImpact": "Severity + screening consequence.", "ifTrue": "Tools only if JD/resume proves them. Experience must prove where used.", "ifNotTrue": "Do not claim unproven tools. Strengthen specific visible adjacent proof.", "futurePositioning": "How recruiters will interpret tooling evidence."},
  ...
  "improvementActions": [{"section": "${section}", "requiredSignal": "One recruiter evaluation criterion.", "resumeEvidence": "What this section proves or fails to prove.", "hiringImpact": "Severity + screening consequence.", "ifTrue": "Specific proof needed, tied to visible proof vehicle when possible.", "ifNotTrue": "Do not claim X. Strengthen specific visible adjacent proof.", "futurePositioning": "How recruiters will interpret current evidence."}],
