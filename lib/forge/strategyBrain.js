...
- Do not invent experience, tools, metrics, projects, credentials, outcomes, clients, or prior roles.
...
- ifTrue should describe:
  - what was built, evaluated, implemented, coordinated, or owned
  - what systems, workflows, APIs, platforms, or technical environments were involved
  - what delivery, technical, stakeholder, or evaluation responsibility existed
- ifTrue must NOT:
  - restate the JD requirement
  - ask for generic "experience"
  - request fake consulting history, fictional clients, or invented prior jobs

Bad:
"If true: Direct project management experience."

Bad:
"If true: Cloud architecture and AI-generated output evaluation tools."

Good:
"If true: Show which systems, APIs, workflows, or technical environments were involved, what implementation or evaluation responsibility existed, and what technical decisions were owned."

Good:
"If true: Show where platform workflows, AI systems, integrations, or delivery coordination were implemented, reviewed, operationalized, or evaluated."

- ifNotTrue must:
  - explicitly tell the candidate not to claim the missing signal
  - preserve the strongest truthful adjacent evidence already visible in the resume
  - reference the most technically relevant visible proof vehicle whenever possible

Bad:
"Strengthen leadership experience in a technical role."

Better:
"Strengthen the visible platform architecture and explainable AI implementation work already present in the resume."

- Prefer the strongest visible technical proof vehicle over generic leadership language.
- Do not collapse platform architecture, AI implementation, systems ownership, APIs, or technical delivery into generic operational leadership.
- Skills may name tools only if:
  1. the JD explicitly names them, OR
  2. the resume already proves them.
...
matchAssessment must lead with the biggest deterministic risk and name the strongest visible support.` : `SINGLE SECTION REQUIREMENTS:
Return only improvementActions with section "${section}".
Do not comment on other sections.`}

STYLE RULES:
- Write like private recruiter notes.
- requiredSignal must sound like a hiring evaluation criterion, not a keyword tag.
- Bad requiredSignal: "project management", "workflow automation", "stakeholder coordination".
- Good requiredSignal: "Direct project delivery ownership", "Workflow automation tooling exposure", "Cross-functional coordination across technical stakeholders".
...
Good:
"Show where platform systems, APIs, technical workflows, or evaluation processes were implemented or reviewed, and what technical responsibility existed."

Good:
"Show which technical environments, systems, or workflows were owned, evaluated, coordinated, or operationalized."

requiredSignal must describe the actual hiring evaluation category, not a broad career domain.
...
If the resume visibly proves:
- platform architecture
- systems design
- AI implementation
- technical product ownership
- API/data-driven systems
- explainable AI models
- end-to-end platform delivery

Then those MUST be treated as stronger proof vehicles than generic operational or leadership experience.
...
Better:
"technical implementation and platform architecture work already visible in the resume"

When stronger technical proof exists, do not fallback to generic operational leadership language.

JSON SHAPE:
${isOverview ? `{
  "opening": "One sharp recruiter-style sentence. Not a bio.",
  "environment": "${hammerContext.environment.label}",
  "matchAssessment": "Private recruiter read. Lead with biggest deterministic risk. Name strongest visible support. No template phrasing.",
  "signalGaps": ["Single most critical missing signal."],
  "improvementActions": [
    {"section": "summary", "requiredSignal": "One recruiter evaluation criterion.", "resumeEvidence": "What Summary proves or fails to prove.", "hiringImpact": "Severity + screening consequence.", "ifTrue": "Show what was built, implemented, evaluated, coordinated, or owned, what systems or workflows were involved, and what responsibility the candidate personally held.", "ifNotTrue": "Do not claim X. Strengthen specific visible adjacent proof.", "futurePositioning": "How recruiters will interpret current evidence and what would reduce risk."},
    {"section": "skills", "requiredSignal": "One technical/tooling signal.", "resumeEvidence": "What Skills proves or fails to prove.", "hiringImpact": "Severity + screening consequence.", "ifTrue": "Show what technical systems, workflows, APIs, platforms, or evaluation processes were used, what responsibility the candidate owned, and where that proof appears in the resume.", "ifNotTrue": "Do not claim unproven tools. Strengthen specific visible adjacent proof.", "futurePositioning": "How recruiters will interpret tooling evidence."},
    {"section": "experience", "requiredSignal": "One work-history proof signal.", "resumeEvidence": "What Experience proves or fails to prove.", "hiringImpact": "Severity + screening consequence.", "ifTrue": "Specific proof needed, tied to visible proof vehicle when possible.", "ifNotTrue": "Do not claim X. Strengthen specific visible adjacent proof.", "futurePositioning": "How recruiters will interpret delivery/ownership evidence."}
  ],
  "prioritySection": "summary | skills | experience | education",
  "reasoning": []
}` : `{
  "opening": "One sharp recruiter-style sentence about this section.",
  "environment": "${hammerContext.environment.label}",
  "matchAssessment": "Honest read of this section against the JD.",
  "signalGaps": ["Most critical missing signal in this section."],
  "improvementActions": [{"section": "${section}", "requiredSignal": "One recruiter evaluation criterion.", "resumeEvidence": "What this section proves or fails to prove.", "hiringImpact": "Severity + screening consequence.", "ifTrue": "Show what was built, implemented, evaluated, coordinated, or owned, what systems or workflows were involved, and what responsibility the candidate personally held.", "ifNotTrue": "Do not claim X. Strengthen specific visible adjacent proof.", "futurePositioning": "How recruiters will interpret current evidence."}],
