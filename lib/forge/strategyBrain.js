...
Adjacent fallback rule:
When using the "If not true" path, do not repeat a generic fallback.
Name the closest specific evidence from the resume snapshot, such as platform architecture, API/system design, live product delivery, cross-functional execution, technical leadership, or stakeholder coordination.
Explain how that adjacent evidence partially supports the JD requirement without pretending it fully satisfies it.
