...
Lead with the biggest screening risk. Be specific to this JD and this resume.
...
- ifNotTrue: Say "Do not claim [specific signal]." Then name the SPECIFIC visible adjacent evidence
  ...
  Name the actual evidence: ForgeTomorrow platform ownership, explainable AI hiring model, etc.
- Never write fictional bullets, invented quotes, made-up metrics, or sample resume sentences.
...
- "highlight transferable skills" → use "strengthen the closest visible adjacent evidence"
...
VISIBLE ADJACENT EVIDENCE — use ONLY what the resume snapshot actually supports:
- ForgeTomorrow platform ownership and live production delivery
- Explainable AI hiring model development
...
QUALITY BAR:
Every improvementAction must help the candidate answer three questions:
1. What can I honestly add if I truly have this experience?
2. What must I NOT claim if I don't?
3. What adjacent evidence I already have can still move me forward?

If an action does not answer all three, rewrite it.
...
${isOverview ? `JSON SHAPE FOR OVERVIEW:
{
  ...
  "environment": "${hammerContext.environment.label}",
  "matchAssessment": "Write your private recruiter read here. Lead with the biggest blocker. Name the strongest visible support. Be specific to this JD and this resume. Do NOT use the template sentence.",
  "signalGaps": [
  ...
  "improvementActions": [
    {
      ...
      "ifTrue": "Describe the TYPE of proof needed — scope, ownership, coordination, outcome. Do NOT write a sample sentence or put words in quotes.",
      "ifNotTrue": "Name the specific visible adjacent evidence from the resume snapshot. Do NOT use generic phrases.",
      "futurePositioning": "One specific forward-looking move. Leave empty string if it would repeat hiringImpact or ifTrue."
    },
    {
      "section": "skills",
      ...
      "hiringImpact": "What will happen at screening if this stays as-is. Be specific.",
      "ifTrue": "Describe how proven skills should be positioned — which category, what context. Do NOT write a sample sentence or put words in quotes.",
      "ifNotTrue": "Name the specific visible adjacent technical evidence from the resume snapshot. Do NOT use generic phrases.",
      "futurePositioning": "One specific forward-looking move. Leave empty string if it would repeat hiringImpact or ifTrue."
    },
    {
      "section": "experience",
      ...
      "hiringImpact": "What will happen at screening if this stays as-is. Be specific.",
      "ifTrue": "Describe the TYPE of delivery proof needed — what was built, who was involved, what changed. Do NOT write a sample sentence or put words in quotes.",
      "ifNotTrue": "Name the specific visible adjacent delivery evidence from the resume snapshot. Do NOT use generic phrases.",
      "futurePositioning": "One specific forward-looking move. Leave empty string if it would repeat hiringImpact or ifTrue."
    }
  ],
  ...
  "improvementActions": [
    {
      ...
      "ifTrue": "Describe the TYPE of proof needed. Do NOT write a sample sentence or put words in quotes.",
      "ifNotTrue": "Name the specific visible adjacent evidence from the resume snapshot. Do NOT use generic phrases.",
      "futurePositioning": "One specific forward-looking move. Leave empty string if redundant."
    }
  ],
  "bulletFixes": [
    {
