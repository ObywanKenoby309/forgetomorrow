...
Rewrite rules:
- Only provide paste-ready wording that is supported by the resume snapshot.
- If a rewrite requires unverified experience, do not write it as fact.
- Use phrases like “If true, add…” only for unverified signals.
- Every suggestion must change how a hiring manager evaluates this candidate for this JD.
`.trim();
}
