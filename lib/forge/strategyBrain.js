...
- ifTrue: what real evidence to add IF the candidate genuinely has it. Be specific to the signal type:
  - Project management → show what was built, who was involved, scope, coordination, outcome
  - Tools/automation → show which tool, what workflow it was applied to, what changed
...
- ifNotTrue: tell them NOT to claim it. Then name the closest honest adjacent evidence from the resume snapshot.
- Never write fictional bullets, made-up metrics, or invented tool names.
  ...
  "improvementActions": [
    {
      ...
      "ifTrue": "Exactly what to add to the Summary if the candidate genuinely has this experience.",
      "ifNotTrue": "What not to claim. What honest adjacent positioning to use instead.",
    ...
    },
    {
      ...
      "hiringImpact": "What will happen at screening if this stays as-is. Be specific.",
      "ifTrue": "Exactly how to place the proven skill in the Skills section.",
      "ifNotTrue": "What not to claim. What adjacent technical evidence to strengthen instead.",
      "futurePositioning": "One specific forward-looking move. Leave empty string if it would repeat hiringImpact or ifTrue."
    },
    {
      "section": "experience",
      ...
      "hiringImpact": "What will happen at screening if this stays as-is. Be specific.",
      "ifTrue": "Exactly what project, ownership, or delivery evidence to add if the candidate has it.",
      "ifNotTrue": "What not to claim. What honest adjacent delivery evidence to strengthen instead.",
      "futurePositioning": "One specific forward-looking move. Leave empty string if it would repeat hiringImpact or ifTrue."
    }
  ],
  ...
  "improvementActions": [
    {
      ...
      "ifTrue": "Exactly what to add if the candidate genuinely has this experience.",
      "ifNotTrue": "What not to claim. What adjacent evidence to strengthen instead.",
