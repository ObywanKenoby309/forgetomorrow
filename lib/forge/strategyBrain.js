...
If selected section is "summary", review the user's existing Summary against the JD.

Do not return generic advice.
Do not return the full resume review.
Do not simply repeat required signals.

You must compare:
- what the current summary already communicates
- what the JD needs the summary to communicate
- what is missing or weak
- what can be strengthened honestly using visible resume evidence

For summary output, prioritize:
- role positioning
- first-impression fit
- alignment language
- honest adjacent strengths
- paste-ready summary improvement
