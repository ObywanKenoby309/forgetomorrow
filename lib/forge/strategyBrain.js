...
- Do not invent experience, tools, metrics, projects, credentials, or outcomes.
...
- ifTrue says what real proof should exist if the claim is true.
- ifNotTrue says what not to claim and names the strongest visible adjacent proof.
- ifNotTrue must still preserve the strongest truthful adjacent evidence.
...
Better:
"Strengthen the end-to-end platform delivery and technical systems ownership already visible in the resume."
- Prefer the most technically relevant visible proof vehicle, not generic leadership.
- Do not collapse founder, architecture, platform, AI, systems, or implementation work into generic operational leadership when stronger technical proof is visible.
- Skills may name tools only if the JD names them or the resume proves them.
- If the JD gives a tool category without naming tools, refer to the category only.
- Never inject popular examples like Zapier, n8n, Make, Salesforce, Jira, OpenAI, Gemini, or Claude unless present in the JD or resume.
