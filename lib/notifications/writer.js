 ...
 *
 * Push notifications fire ONLY on first creation (not on dedupe re-fires), so breach-style
 * alerts don't spam a user's phone every time the underlying trigger re-checks.
 *
