...
const isCustomerSupportIntent = intent.roleTerms.some((term) =>
  ...
  if (isDesktopSupportIntent && desktopSupportHits.length) {
...
if (isSoftwareIntent && softwareEngineeringHits.length >= 3) {
...
if (isCustomerSuccessIntent && customerSuccessHits.length >= 3) {
