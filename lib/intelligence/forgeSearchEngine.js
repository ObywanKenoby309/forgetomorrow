...
function getJobIntentClusterKeys(keyword) {
  ...
  if (q === 'customer' || q.includes('customer experience')) {
    add('customerSupport', 'customerSuccess');
  }

  if (
    q.includes('customer support') ||
    q.includes('customer service') ||
    q.includes('support manager') ||
    q.includes('technical support') ||
    q.includes('help desk') ||
    q.includes('service desk') ||
    q.includes('client services')
  ) {
    add('customerSupport', 'customerSuccess', 'desktopSupport');
  }

  if (
    q.includes('customer success') ||
    q.includes('client success') ||
    q.includes('account manager') ||
    q.includes('account management') ||
    q.includes('customer experience')
  ) {
    add('customerSuccess', 'customerSupport');
  }
...
function scoreJobSearch(job, filters = {}) {
  ...
  const intentClusterKeys = getJobIntentClusterKeys(keyword);
