...
export const CAPABILITY_CLUSTERS = {
  ...
  customerLifecycle: uniq([
    ...mergeCapabilityTerms('customer_retention', 'customer_onboarding', 'customer_adoption', 'customer_health_management', 'renewals_expansion', 'voice_of_customer', 'executive_business_reviews'),
    'customer lifecycle',
    'success planning',
    'customer journey',
  ]),

  serviceOperations: uniq([
    ...mergeCapabilityTerms('service_operations', 'sla_management', 'incident_management', 'problem_management', 'major_incident_management', 'capacity_planning', 'workforce_management', 'operational_reporting', 'contact_center_operations'),
    'support operations',
    'service governance',
    'delivery governance',
  ]),

  leadershipOperations: uniq([
    ...mergeCapabilityTerms('people_leadership', 'executive_communication', 'budget_ownership', 'organizational_development', 'talent_development', 'operations_process_improvement'),
    'director',
    'senior manager',
  ...
  fieldService: uniq([
    ...mergeCapabilityTerms('field_service_operations', 'transportation_fleet', 'customer_service_support', 'service_operations'),
  ...
  engineering: uniq([
    ...mergeCapabilityTerms('mechanical_engineering', 'electrical_engineering', 'quality_management', 'manufacturing_production'),
    'design engineer',
    'controls engineer',
    'engineering operations',
  ]),
  cleaningJanitorial: uniq([
    ...mergeCapabilityTerms('cleaning_janitorial'),
    'cleaner',
    'janitor',
    'custodian',
    'housekeeper',
  ...
  socialServices: uniq([
    ...mergeCapabilityTerms('social_work_services', 'community_social_services'),
    'social worker',
    'case manager',
    'case worker',
    'human services',
  ...
  warehouseForklift: uniq([
    ...mergeCapabilityTerms('warehouse_forklift', 'logistics_supply_chain'),
    'forklift',
    'fork truck',
    'forklift operator',
    'fork truck driver',
  ...
  generalLabor: uniq([
    ...mergeCapabilityTerms('general_labor'),
    'laborer',
    'general laborer',
    'general labor',
    'helper',
  ...
  facilitiesMaintenance: uniq([
    ...mergeCapabilityTerms('maintenance_facilities'),
    'maintenance',
  ...
  retailCashier: uniq([
  ...mergeCapabilityTerms('retail_store_operations'),
  'cashier',
  'retail cashier',
  'store associate',
  'retail associate',
...
export const TERM_ALIASES = {
  ...
  'customer retention': CAPABILITY_CLUSTERS.customerLifecycle,
  'client retention': CAPABILITY_CLUSTERS.customerLifecycle,
  'customer onboarding': CAPABILITY_CLUSTERS.customerLifecycle,
  'customer adoption': CAPABILITY_CLUSTERS.customerLifecycle,
  'customer health': CAPABILITY_CLUSTERS.customerLifecycle,
  renewals: CAPABILITY_CLUSTERS.customerLifecycle,
  'voice of customer': CAPABILITY_CLUSTERS.customerLifecycle,
  qbr: CAPABILITY_CLUSTERS.customerLifecycle,
  ebr: CAPABILITY_CLUSTERS.customerLifecycle,

  'service operations': CAPABILITY_CLUSTERS.serviceOperations,
  'support operations': CAPABILITY_CLUSTERS.serviceOperations,
  'incident manager': CAPABILITY_CLUSTERS.serviceOperations,
  'major incident manager': CAPABILITY_CLUSTERS.serviceOperations,
  'workforce management': CAPABILITY_CLUSTERS.serviceOperations,
  'capacity planning': CAPABILITY_CLUSTERS.serviceOperations,
  'sla management': CAPABILITY_CLUSTERS.serviceOperations,

  'operations director': CAPABILITY_CLUSTERS.leadershipOperations,
  'service delivery director': CAPABILITY_CLUSTERS.leadershipOperations,
  'customer success director': CAPABILITY_CLUSTERS.leadershipOperations,
  'client services director': CAPABILITY_CLUSTERS.leadershipOperations,

  'field service': CAPABILITY_CLUSTERS.fieldService,
  'field operations': CAPABILITY_CLUSTERS.fieldService,
  dispatcher: CAPABILITY_CLUSTERS.fieldService,

  engineer: CAPABILITY_CLUSTERS.engineering,
  'mechanical engineer': CAPABILITY_CLUSTERS.engineering,
  'electrical engineer': CAPABILITY_CLUSTERS.engineering,
  'controls engineer': CAPABILITY_CLUSTERS.engineering,
  'quality manager': CAPABILITY_CLUSTERS.engineering,
  
  cashier: CAPABILITY_CLUSTERS.retailCashier,
'retail cashier': CAPABILITY_CLUSTERS.retailCashier,
'store associate': CAPABILITY_CLUSTERS.retailCashier,
'retail associate': CAPABILITY_CLUSTERS.retailCashier,
'cashier associate': CAPABILITY_CLUSTERS.retailCashier,
'front end associate': CAPABILITY_CLUSTERS.retailCashier,
'sales floor associate': CAPABILITY_CLUSTERS.retailCashier,
'store clerk': CAPABILITY_CLUSTERS.retailCashier,
};
...
export const JOB_INTENT_FAMILIES = {
  ...
  customerLifecycle: {
    ...
    primaryClusters: ['customerLifecycle'],
    adjacentClusters: ['customerSuccess', 'serviceOperations', 'sales'],
    semanticTerms: CAPABILITY_CLUSTERS.customerLifecycle,
  },
  ...
  serviceOperations: {
    ...
    primaryClusters: ['serviceOperations'],
    adjacentClusters: ['customerSuccess', 'operations', 'projectManagement', 'dataAnalytics'],
    semanticTerms: CAPABILITY_CLUSTERS.serviceOperations,
  },
  ...
  leadershipOperations: {
    ...
    primaryClusters: ['leadershipOperations'],
    adjacentClusters: ['operations', 'customerSuccess', 'projectManagement', 'financeAccounting'],
    semanticTerms: CAPABILITY_CLUSTERS.leadershipOperations,
  },
  ...
  fieldService: {
    ...
    primaryClusters: ['fieldService'],
    adjacentClusters: ['operations', 'logisticsSupplyChain', 'customerSupport'],
    semanticTerms: CAPABILITY_CLUSTERS.fieldService,
  },
  ...
  engineering: {
    ...
    primaryClusters: ['engineering'],
    adjacentClusters: ['manufacturing', 'operations', 'quality_management'],
    semanticTerms: CAPABILITY_CLUSTERS.engineering,
  },
  ...
  cleaningJanitorial: {
    ...
    primaryClusters: ['cleaningJanitorial'],
    adjacentClusters: ['facilitiesMaintenance'],
    semanticTerms: CAPABILITY_CLUSTERS.cleaningJanitorial,
  },
  ...
  socialServices: {
    ...
    primaryClusters: ['socialServices'],
    adjacentClusters: ['healthcareAdmin', 'educationTraining'],
    semanticTerms: CAPABILITY_CLUSTERS.socialServices,
  },
  ...
  warehouseForklift: {
    ...
    primaryClusters: ['warehouseForklift'],
    adjacentClusters: ['logisticsSupplyChain', 'generalLabor'],
    semanticTerms: CAPABILITY_CLUSTERS.warehouseForklift,
  },
  ...
  generalLabor: {
    ...
    primaryClusters: ['generalLabor'],
    adjacentClusters: ['warehouseForklift', 'facilitiesMaintenance'],
    semanticTerms: CAPABILITY_CLUSTERS.generalLabor,
  },
  ...
  facilitiesMaintenance: {
    ...
    primaryClusters: ['facilitiesMaintenance'],
    adjacentClusters: ['cleaningJanitorial', 'engineering'],
    semanticTerms: CAPABILITY_CLUSTERS.facilitiesMaintenance,
  },
  ...
  primaryClusters: ['retailCashier'],
  adjacentClusters: ['customerSupport', 'sales'],
  semanticTerms: CAPABILITY_CLUSTERS.retailCashier,
}, 
};
...
export const CONFLICTING_ECOSYSTEMS = {
  ...
  customerLifecycle: ['forklift', 'machine operator', 'react', 'next.js', 'clinical laboratory', 'paralegal'],
  serviceOperations: ['frontend developer', 'graphic design', 'retail cashier', 'food prep'],
  leadershipOperations: ['entry-level only', 'internship only'],
  fieldService: ['software engineer', 'account executive', 'content writer'],
  engineering: ['customer service representative', 'call center', 'retail cashier', 'food service'],
  retailCashier: ['software engineer', 'frontend developer', 'react', 'next.js', 'cloud engineer', 'cybersecurity', 'forklift operator', 'mechanical engineer',],
  cleaningJanitorial: ['director', 'executive', 'data analyst', 'data entry', 'software engineer', 'financial analyst', 'forklift operator', 'fork truck driver',],
  socialServices: ['forklift', 'fork lift', 'forklift operator', 'fork truck', 'fork truck driver', 'warehouse', 'warehouse associate', 'warehouse worker', 'material handler', 'order picker', 'shipping', 'receiving', 'loading', 'unloading', 'pallet jack', 'distribution center', 'fulfillment center', 'machine operator', 'assembly', 'manufacturing', 'production', 'general labor', 'laborer', 'warehouse laborer', 'software engineer',],
  warehouseForklift: ['social worker', 'social work', 'case manager', 'case worker', 'human services', 'family services', 'community support worker', 'youth advocate', 'community outreach', 'social services', 'crisis intervention', 'client advocacy', 'paralegal', 'teacher', 'software engineer',],
  generalLabor: ['director', 'executive', 'software engineer', 'financial analyst', 'social worker', 'case manager',],
  facilitiesMaintenance: ['social worker', 'social work', 'case manager', 'case worker', 'human services', 'paralegal', 'content writer',],
};
