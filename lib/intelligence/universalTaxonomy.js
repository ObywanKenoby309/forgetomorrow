...
export const UNIVERSAL_ROLE_FAMILIES = {
  ...
  operations_supply_chain: ["operations_process_improvement", "quality_management", "capacity_planning", "workforce_management", "operational_reporting", "manufacturing_production", "logistics_supply_chain", "procurement_vendor_management", "transportation_fleet", "field_service_operations", "safety_environmental_compliance"],
  people_public_service: ["people_leadership", "talent_development", "organizational_development", "hr_people_operations", "recruiting_talent_acquisition", "education_training", "training_enablement", "government_military", "public_safety_security", "community_social_services"],
  ...
  engineering_trades: ["mechanical_engineering", "electrical_engineering", "construction_trades", "manufacturing_production", "quality_management", "safety_environmental_compliance", "field_service_operations"],
};
