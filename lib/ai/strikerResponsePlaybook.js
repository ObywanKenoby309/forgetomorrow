...
export const STRIKER_PAGE_GUIDES = {
  anvil: {
    short:
      "You're currently in The Anvil, your professional workshop on ForgeTomorrow.",
  ...
  jobs: {
    short:
      "You're currently in Apply to Jobs.",
  ...
  forgeVault: {
    short:
      "You're currently in ForgeVault.",
    ...
    details: [
      ...
      "Share documents",
      "Access files across ForgeTomorrow",
    ],
  },

  foundry: {
    short:
      "You're currently in Foundry.",

    purpose:
      "This area helps people collaborate, meet, and work together inside ForgeTomorrow.",

    details: [
      "Host meetings",
      "Join meetings",
      "Share files",
      "Collaborate with coaches, recruiters, and seekers",
    ],
  },
};
