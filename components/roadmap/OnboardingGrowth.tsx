    ...
    return (
      <div>
        ...
        <p className="text-lg text-gray-700 mb-8">
          Let our AI analyze your resume and generate a personalized 12-month career
          acceleration roadmap — including 30/60/90 day goals, skill gaps, promotion
          timeline, and high-impact projects.
        </p>
            ...
            >
              {loading ? (
                <>
                  ...
                  Generating Your 12-Month Forge Plan...
                </>
              ) : (
                'Generate My Forge Plan'
              )}
            </button>
