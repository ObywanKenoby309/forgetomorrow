  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1200px] h-full px-4 flex items-center justify-between gap-4">
        ...
        {/* Right: actions */}
        <div className="flex items-center gap-3">
          {/* Unread badge to The Signal (optional: replace count when wired) */}
          <Link
          ...
          >
            The Signal
            <span className="ml-1 inline-flex items-center justify-center text-[10px] font-bold text-white rounded-full px-1.5 h-4"
          ...
          <div className="relative" ref={menuRef}>
            <button
              ...
              className="w-8 h-8 rounded-full bg-gray-500 border border-black/30 outline-none"
              title="Account"
            />
            {menuOpen && (
              <div
