...
// Persistent right-rail day detail panel for the recruiter calendar page.
// Shows the selected day's events. Stacks above RightRailPlacementManager.
...
function typeColors(type) {
  ...
  if (t === 'screen' || t === 'phone screen') return { strip: '#4CAF50', pillBg: '#E8F5E9', pillFg: '#2E7D32' };
  if (t === 'offer') return { strip: '#FF7043', pillBg: '#FFF3E0', pillFg: '#C75B33' };
  if (t === 'sourcing') return { strip: '#FF9800', pillBg: '#FFF8E1', pillFg: '#E65100' };
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 13, fontWeight: 800, color: '#112033', lineHeight: 1.3 }}>{label}</div>
          {selectedDate && (
      ...
      <div style={{ padding: '10px 12px', display: 'flex', flexDirection: 'column', gap: 8, maxHeight: 320, overflowY: 'auto' }}>
        ...
        {events.map((e) => {
          ...
          const titleText = e.title || (e.candidateName && e.type
            ...
            >
              ...
              <div style={{ padding: '8px 10px' }}>
                ...
                <div style={{ display: 'flex', gap: 4, flexWrap: 'wrap' }}>
                  <span style={{ fontSize: 10, background: pillBg, color: pillFg, padding: '1px 6px', borderRadius: 999, fontWeight: 700 }}>
                    {e.type}
                  </span>
                  <span style={{
                    fontSize: 10,
