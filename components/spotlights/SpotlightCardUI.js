...
export function SpotlightCard({ spotlight, selected, onSelect }) {
  ...
  const {
    ...
    specialties, rate, availability, csat,
    userId, userSlug, userAvatarUrl,
  } = spotlight;
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
        ...
        <div style={{ display: 'flex', gap: 5, flexShrink: 0 }}>
          <button onClick={handleProfile} style={btnOutline}>Profile</button>
          <button onClick={handleBook}    style={btnOutline}>Book</button>
          <button
...
const btnOutline = {
  ...
  border: '0.5px solid #FF7043', borderRadius: 6,
