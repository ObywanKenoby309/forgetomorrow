// components/layouts/AnvilLayout.js
// Anvil-specific layout: left rail collapses independently, right rail stays visible at reduced scale.
...
export default function AnvilLayout({
  ...
  // Anvil: right rail always stays visible — only left collapses
          ...
          {hasRight ? (
            <aside
              style={{
                ...
                overflow: 'hidden',
                // Anvil: right rail always visible — opacity/pointerEvents never tied to collapseSiderails
                opacity: 1,
                pointerEvents: 'auto',
