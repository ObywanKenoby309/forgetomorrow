...
function CandidateCard({
  ...
  return (
    <div className="group relative flex h-full min-h-[168px] w-full max-w-full min-w-0 flex-col rounded-xl border border-slate-200/80 bg-white shadow-sm transition-shadow duration-150 hover:shadow-md" style={{ overflow: "visible", position: "relative", zIndex: 1 }}>
      {/* Left accent bar */}
      <div
      ...
      <div className="flex min-h-[168px] flex-1 flex-col min-w-0 max-w-full overflow-hidden pl-4 pr-4 py-3">
        ...
        {(displayLocation || workTypeLabel || statusObj || relocateLabel) && (
          <div className="mt-2 flex min-w-0 max-w-full flex-wrap items-center gap-1.5 overflow-hidden">
            {displayLocation && (
        ...
        {/* Skills preview */}
        <div className="mt-2 min-h-[24px] max-h-[28px] overflow-hidden">
          {skillsList.length > 0 && (
