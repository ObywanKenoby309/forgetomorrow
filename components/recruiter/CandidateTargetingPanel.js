...
export default function CandidateTargetingPanel({
  ...
  manualSearching,
  isLoading,
  // When true (e.g. inside the targeting drawer), skips the toggle button
  // and renders the form directly — no extra click in the chain.
  ...
  // If defaultExpanded is true, the toggle is bypassed entirely.
  const [targetingOpen, setTargetingOpen] = useState(false);
  const isOpen = defaultExpanded || targetingOpen;
