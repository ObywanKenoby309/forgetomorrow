...
function DeleteDataAndAccountSection() {
  ...
  return (
    <section className="mt-10 border border-red-200 rounded-lg p-4 bg-red-50">
      ...
      <p className="mt-2 text-sm text-red-900">
        These actions are permanent. Please read the red warning text carefully before continuing.
      </p>

      <div className="mt-4 grid gap-4 md:grid-cols-2">
        {/* Option 1: Clear data, keep account */}
        <button
          type="button"
      ...
      {mode && (
        <div className="mt-5 border-t border-red-200 pt-4">
          ...
          <p className="mt-1 text-xs text-red-900">
            ...
            <span className="font-mono font-bold">DELETE</span> in the box below and press the
            button to continue.
          </p>
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-8">
      ...
      <p className="mt-2 text-sm text-gray-700">
        From here you can clear your personal data or permanently delete your ForgeTomorrow account.
      </p>

      <DeleteDataAndAccountSection />
    </main>
  );
}
