      ...
      <>
        ...
        <style>{`
          *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .ft-asset-popover { position: fixed; inset: 20px; z-index: 10000; display: flex; flex-direction: column; width: auto; height: auto; max-width: 760px; max-height: calc(100vh - 40px); margin: auto; background: rgba(10,18,30,.98); border: 1px solid rgba(255,255,255,.14); border-radius: 18px; box-shadow: 0 28px 80px rgba(0,0,0,.62); overflow: hidden; }
          ...
          .ft-asset-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(136px, 1fr)); grid-auto-rows: max-content; align-content: start; gap: 10px; height: 100%; min-height: 0; overflow-y: auto; overflow-x: hidden; padding-right: 4px; scrollbar-width: thin; scrollbar-color: rgba(255,112,67,0.3) transparent; }
		  .ft-asset-grid-wrap { flex: 0 0 165px; min-height: 165px; overflow: hidden; }
          ...
          .ft-asset-popover-foot { position: sticky; bottom: 0; z-index: 2; display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 12px 18px 16px; background: rgba(10,18,30,0.98); border-top: 1px solid rgba(255,255,255,0.08); flex-shrink: 0; }
      ...
      {slugError}
                    ...
                    {SOCIAL_FIELDS.map(f => (
                      <div key={f.key} className="ft-dark-field">
                        ...
                        <input className="ft-dark-input" type="url" value={socialLinks[f.key] || ''} onChange={e => updateSocial(f.key, e.target.value)} placeholder={f.placeholder} />
                      </div>
                    ))}
                    <div className="ft-dark-field">
                      <label className="ft-dark-label">Profile Visibility</label>
...
<div className="ft-asset-grid-wrap">
  ...
  return (
    <div className="ft-card">
      <div className="ft-card-inner">
        ...
        <div className="ft-skills-scroll-wrap">
  ...
  return (
    <div className="ft-dark-card">
      <div className="ft-dark-card-inner">
        ...
        {skills.length > 0 && (
          <div className="ft-skills-scroll-wrap" style={{ marginTop: 10 }}>
