...
function HearthHero({ greeting, isMobile }) {
  if (!isMobile) {
    return (
      <SeekerTitleCard
        greeting={greeting}
  ...
  return (
    ...
    >
      ...
      >
        Build connections, find mentors, and grow your professional network with purpose.
      </p>
      <Link
...
export default function TheHearth() {
  ...
  return (
    <Layout
      ...
      header={<HearthHero greeting={greeting} isMobile={isMobile} />}
      headerCard={false}
      activeNav={activeNav}
      rightVariant="light"
      right={
