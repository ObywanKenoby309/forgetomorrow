        ...
        <div style={{ display: 'grid', gap: GAP, width: '100%', boxSizing: 'border-box' }}>
          ...
          <div style={{ ...GLASS, padding: 20 }}>
            ...
            <div style={{ background: 'rgba(255,255,255,0.88)', borderRadius: 12, overflow: 'hidden', border: '1px solid rgba(0,0,0,0.07)' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '2fr 2fr 120px 160px 140px 120px', padding: '8px 16px', background: 'rgba(0,0,0,0.02)', borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
              ...
              {filtered.map((c, i) => (
                <div key={i} style={{ display: 'grid', gridTemplateColumns: '2fr 2fr 120px 160px 140px 120px', padding: '12px 16px', borderBottom: i < filtered.length - 1 ? '1px solid rgba(0,0,0,0.05)' : 'none', alignItems: 'center', background: i % 2 === 1 ? 'rgba(0,0,0,0.01)' : 'transparent' }}>
