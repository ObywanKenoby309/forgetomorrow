...
const CANDIDATES = [
  {
    name: 'Alexandra Hawkins', title: 'Desktop Support · Client Services',
    location: 'Glasgow, KY · Bowling Green, KY', workType: 'Flexible',
  ...
  {
    name: 'Joel Flores Bustamante', title: 'Title not provided',
    location: null, workType: null,
    status: null, why: 100,
    skills: ['Technical Support (Windows, MacOS, Networking)', 'Microsoft 365, Azure, Active Directory'],
    summary: ['Project Management & Team Leadership', 'Customer Success & Escalation Management'],
  },
  {
    name: 'Eric James', title: 'Founder & CEO of ForgeTomorrow | Building Human-First Career Infrastructure for the Future of Work',
    location: 'Nashville, TN', workType: 'Remote',
    status: 'Not Looking', why: 100,
    skills: ['Client Success Leadership', 'Customer Operations & Escalation Management', 'Support Delivery & SLA Management', 'Technical Support Management (Tiered Support)'],
    summary: [],
  },
  {
    name: 'John Smith', title: 'Senior Desktop Tech at Healthcare Network',
    location: 'Nashville, TN', workType: 'On-site',
    status: 'Open to Opportunities', why: 76,
    extra: 'Open to relocate',
    skills: ['Windows 10/11', 'Active Directory', 'Office 365', 'SCCM Imaging', 'ServiceNow ticketing'],
    summary: [],
  },
  {
    name: 'Jane Doe', title: 'Title not provided',
    location: 'Bowling Green, KY', workType: 'Hybrid',
    status: 'Actively Seeking', why: 71,
    skills: ['Active Directory', 'Troubleshooting hardware, software, and networking', 'Ticketing systems', 'Customer service'],
    summary: [],
  },
  {
    name: 'Daiga Džeimsa', title: null,
    location: 'Jūrmala, Latvia', workType: null,
    status: null, why: 36,
    skills: ['Software Testing', 'Communication', 'Quality Control', 'Problem Solving'],
    summary: [],
  },
];
