      ...
      <main className="flex items-center justify-center min-h-screen bg-[#ECEFF1] text-[#212121] px-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full mt-20">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full bg-[#333] text-white py-3 rounded font-semibold hover:bg-[#24292e] transition-colors flex items-center justify-center gap-2"
          >
            {isLoading ? (
              'Redirecting...'
            ) : (
          ...
          <p className="mt-6 text-center text-gray-600 text-sm">
            No password needed. We’ll create your profile instantly.
          </p>
