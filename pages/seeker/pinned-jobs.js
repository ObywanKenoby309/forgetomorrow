  ...
  const Header = (
    <section className="bg-white border border-gray-200 rounded-xl p-8 text-center shadow-sm">
      ...
      <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
        These are the roles you’ve flagged as “worth fighting for.” Keep them
        here and come back anytime.
      </p>
    </section>
  );
          ...
          {pinned.length === 0 ? (
            <div className="text-center py-24 bg-gray-50 rounded-2xl">
              ...
              <p className="text-gray-600 mt-4 max-w-md mx-auto">
                When you see a role that feels right, hit the pin. It’ll appear
                here.
              </p>
            </div>
          ) : (
                  ...
                  <div>
                    ...
                    {job.pinnedAt && (
                      <p className="text-sm text-gray-500 mt-3">
                        Pinned on{' '}
                        {new Date(job.pinnedAt).toLocaleDateString()}
                      </p>
                    )}
                  </div>
                  <button
                    // TODO: wire up real unpin via DELETE endpoint
