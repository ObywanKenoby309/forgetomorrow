    ...
    <div style={{
      ...
      <div style={{
        ...
        {tabs.map((tab) => {
          ...
          return (
            <Link key={tab.key} href={withChrome(tab.href)} style={{
              flexShrink: 0,
              ...
              {tab.badge > 0 && (
                <span style={{
                  fontSize: 11, fontWeight: 900, borderRadius: 999, padding: '1px 6px',
    ...
    >
      <div style={PAGE_GLASS_WRAP}>
        ...
        <section style={{ display: 'grid', gap: 12,
          gridTemplateColumns: 'minmax(0, 1.4fr) minmax(0, 1fr)', marginTop: 12 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <button type="button" onClick={() => setShowContacts((v) => !v)}
                  ...
                  aria-expanded={showContacts} aria-controls="contacts-panel">
        ...
        <section style={{ display: 'grid', gap: 12,
          gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', marginTop: 12 }}>
          <section style={{ ...WHITE_CARD, padding: 16 }}>
