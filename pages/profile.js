...
export default function ProfilePage() {
  ...
  // ✅ FIX: allow null so components can treat as "not loaded yet"
  ...
  useEffect(() => {
    try {
      ...
      // ✅ FIX: if nothing in storage, keep null (so UI can load server truth)
  ...
  // ✅ FIX: only write about when it's not null
  useEffect(() => {
    try {
