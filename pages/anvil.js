  ...
  const HeaderBox = (
    ...
    >
      ...
      <p className="text-sm md:text-base text-gray-600 mt-2 max-w-3xl mx-auto">
        Shape your career with guided tools for profile strength, negotiation readiness,
        and Pivot &amp; Growth Roadmaps.
      </p>
    </section>
  );
      ...
      >
        ...
        {!activeModule && (
          <>
            ...
            >
              Use The Anvil to strengthen your professional presence, prepare for
            ...
            >
              <strong>Usage note:</strong> Free plan users receive one personalized Pivot
              &amp; Growth Roadmap. Please upload a complete resume using the{" "}
              <a
