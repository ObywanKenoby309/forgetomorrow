  ...
  const HeaderBox = (
    <section style={glassHero}>
      ...
      <p style={{ margin: '6px auto 0', color: '#607D8B', maxWidth: 720 }}>
        Share what you offer. Clients will connect through ForgeTomorrow messaging and scheduling.
      </p>
    </section>
  );
    ...
    >
      <section style={glassCard}>
        ...
        <div style={infoBox}>
          ...
          <div>
            This spotlight will route through ForgeTomorrow messaging and calendar scheduling tied to your coach slug.
          </div>
        </div>
