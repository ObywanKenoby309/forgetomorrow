  ...
  return (
    <CoachingLayout title="Coaching Dashboard | ForgeTomorrow" activeNav="dashboard" contentFullBleed sidebarInitialOpen={{coaching:true,seeker:false}}>
      <div style={{ width:'100%', padding:0, margin:0, paddingRight:16, boxSizing:'border-box' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:`minmax(0,1fr) ${RIGHT_COL_WIDTH}px`, gridTemplateRows:'auto auto auto auto', gap:GAP, width:'100%', minWidth:0, boxSizing:'border-box' }}>
          ...
          <div style={{ gridColumn:'1/-1', gridRow:'4', display:'grid', gridTemplateColumns:'minmax(0,6fr) minmax(0,4fr) minmax(0,2fr)', gap:GAP, marginLeft:-252, boxSizing:'border-box', minWidth:0 }}>
