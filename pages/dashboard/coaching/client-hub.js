...
const TILES = [
  {
    ...
    src: "/dashboard/coaching/clients",
  },
  {
    id: "sessions",
    title: "Sessions",
    ...
    src: "/dashboard/coaching/sessions",
  },
  {
    id: "feedback",
    title: "Feedback",
    ...
    src: "/dashboard/coaching/feedback",
  },
];
      ...
      <div style={{ padding: "0 16px 14px", position: "relative", zIndex: 20 }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <CoachHubIcon label={active.id} size={28} />
...
export default function ClientHub() {
  ...
  const HeaderBox = (
    <CoachingTitleCard
      greeting={greeting}
      title="Client Hub"
      subtitle="Choose the coaching workspace you want to open. Each tool loads inside Client Hub."
      compact
    />
  );
    ...
    >
      <section style={{ padding: 0, display: "grid", gap: 12 }}>
        {!activeModule ? (
          ...
          >
            <ToolFrame
              src={activeTile?.src || "/dashboard/coaching/clients"}
