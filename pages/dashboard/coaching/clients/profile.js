                          ...
                          >
                            ...
                            <div className="relative z-[1] flex min-h-[326px] flex-col items-center justify-end gap-2 px-3 pb-3 pt-7 text-center">
                              ...
                              <div className="grid w-full grid-cols-1 gap-2 pt-1">
                                <button type="button" onClick={() => router.push('/dashboard/coaching/sessions')} className="rounded-xl border border-white/35 bg-white/94 px-2.5 py-1.5 text-[13px] font-black text-slate-800 shadow-[0_8px_18px_rgba(2,6,23,0.18)] hover:bg-white transition">
                                  View Sessions
                                </button>
                                <button type="button" onClick={() => router.push('/coaching/messaging')} className="rounded-xl border border-white/35 bg-white/94 px-2.5 py-1.5 text-[13px] font-black text-slate-800 shadow-[0_8px_18px_rgba(2,6,23,0.18)] hover:bg-white transition">
                                  Message
                                </button>
                                {profileHref ? (
                                  <button type="button" onClick={openProfile} className="rounded-xl border border-white/35 bg-white/94 px-2.5 py-1.5 text-[13px] font-black text-slate-800 shadow-[0_8px_18px_rgba(2,6,23,0.18)] hover:bg-white transition">
                                    View Profile
                                  </button>
                                ) : null}
                              </div>
