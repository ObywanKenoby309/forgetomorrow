...
export default function CoachingFeedbackDashboardPage() {
  ...
  return (
    <CoachingLayout
      ...
      activeNav="feedback"
      headerDescription="View ratings and testimonials; filter by coach and consent."
                ...
                <div key={f.id} style={card}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12 }}>
                    <div>
                      ...
                      <span style={{ marginLeft: 8, color: '#607D8B', fontSize: 12 }}>
                        {fmtDate(f.createdAt)}
                      </span>
                    </div>
                  ...
                  {f.comment && (
                    <div style={{ color: '#455A64', marginTop: 6, whiteSpace: 'pre-wrap' }}>
                      {f.comment}
                    </div>
                  )}
                </div>
