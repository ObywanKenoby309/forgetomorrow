      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 text-center">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-white">
          ...
          <p className="text-2xl md:text-4xl max-w-4xl mx-auto drop-shadow-lg">
            ...
            <span className="text-[#FF7043]">We’ll update with new and exciting posts soon.</span>
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="border rounded-lg shadow-lg overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex-1 flex flex-col">
                <h3 className="text-2xl font-bold mb-4">How We Built the Resume Builder</h3>
            ...
            <div className="border rounded-lg shadow-lg overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex-1 flex flex-col">
                <h3 className="text-2xl font-bold mb-4">Coach Spotlight: Emphasizing Mentorship</h3>
                <p className="flex-1 text-gray-700">
            ...
            <div className="border rounded-lg shadow-lg overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex-1 flex flex-col">
                <h3 className="text-2xl font-bold mb-4">Recruiter Insights: Transparent Matching</h3>
                <p className="flex-1 text-gray-700">
...
<div className="border rounded-lg shadow-lg overflow-hidden flex flex-col">
  ...
  <div className="h-40 w-full overflow-hidden" style={{ backgroundColor: '#0F1D35' }}>
    <img
  ...
  <div className="p-6 flex-1 flex flex-col">
    <h3 className="text-2xl font-bold mb-4">A Welcome from Our Founder</h3>
    <p className="flex-1 text-gray-700">
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-12">
          ...
          <div className="mt-12">
            ...
            <p className="mt-8 text-sm text-gray-500">
              Every submission lands instantly in <strong>blog@forgetomorrow.com</strong>
            </p>
          </div>
        </div>
      </section>
