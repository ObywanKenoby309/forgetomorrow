...
// ─── Page body ────────────────────────────────────────────────────────────────
export default function CommandInlay({ filters, onFilterChange, isMobile }) {
  ...
  const recruiterActivityCard = (
    <div style={{ ...GLASS, borderRadius: 18, padding: 16, width: "100%", minWidth: 0 }}>
      ...
      >
        ...
        <Link
          href="/recruiter/analytics?tab=reports&report=recruiters"
          style={{
            color: ORANGE,
            fontWeight: 800,
            fontSize: 13,
  ...
  const sourcePerformanceCard = (
    <div style={{ ...GLASS, borderRadius: 18, padding: 16, width: "100%", minWidth: 0 }}>
      ...
      >
        ...
        <Link
          href="/recruiter/analytics?tab=reports&report=sources"
          style={{
            color: ORANGE,
            fontWeight: 800,
            fontSize: 13,
  ...
  const applicationFunnelCard = (
    <div style={{ ...GLASS, borderRadius: 18, padding: 16, width: "100%", minWidth: 0 }}>
      ...
      >
        ...
        <Link
          href="/recruiter/analytics?tab=reports&report=funnel"
          style={{
            color: ORANGE,
            fontWeight: 800,
            fontSize: 13,
  ...
  // ── Desktop layout — bottom-aligned so side cards do not stretch to center height
  const DesktopBlock = (
    <>
      <div
        style={{
